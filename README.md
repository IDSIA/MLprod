...
To develop this application, a [Python virutal environmnet](https://docs.python.org/3/tutorial/venv.html) is highly recommended.
If a development machine with Docker is not available, it is possible to install the application to create a fully working environment:
